...
export const searchBuses = ({ start, end }) => {
    return new Promise((resolve, reject) => {
        // Mocking bus data for demonstration purposes
        const busData = [
            { _id: '1', name: 'Bus 1', company: 'Company A', stops: 5 },
            { _id: '2', name: 'Bus 2', company: 'Company B', stops: 7 },
            // Add more bus data as needed
        ];
        resolve(busData);
        // If there's an error, reject the promise
        // reject(new Error('Failed to search buses'));
    });
};
